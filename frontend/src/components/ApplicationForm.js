...
<div class="flex flex-col md:flex-row md:space-x-4">
  ...
  <div class="w-full md:w-1/3 mb-4 md:mb-0">
    <label htmlFor="city" class="flex items-start mb-2 font-medium text-gray"> City </label>
    <input
      type="text"
      id="city"
      value={formData.city}
...
<div class="flex flex-col md:flex-row md:space-x-4">
  ...
  {/* Date Input */}
  <div class="w-full md:w-1/3 mb-4 md:mb-0">
    <label htmlFor="date" class="flex items-start mb-2 font-medium text-gray"> Date </label>
    <input
      type="date"
      id="date"
      value={formData.date}
