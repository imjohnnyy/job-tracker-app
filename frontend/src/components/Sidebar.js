      ...
      <div className="flex flex-col w-64 px-8 py-4 bg-gray">
        ...
        <nav className="mt-[5rem]">
          <ul className="space-y-3">
            <li>
              <a href="#dashboard" className="flex items-center justify-start py-2 text-lg font-semibold rounded-sm text-zinc-300 hover:text-white hover:bg-slate-500">
              <DashboardIcon className="my-1 ml-[10px] mr-[8px]" style={{ fontSize: '150%' }} /> Dashboard
              </a>
            </li>
            <li>
              <a href="#about" className="flex items-center justify-start py-2 text-lg font-semibold rounded-sm text-zinc-300 hover:text-white hover:bg-slate-500">
