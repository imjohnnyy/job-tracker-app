      ...
      <div className="w-full p-4 bg-blue-100 h-54 rounded-2xl border-light-blue-200">
        ...
        <div className="grid items-start grid-cols-1">
          <div className="flex flex-col items-start">
            <p className="font-semibold text-md sm:text-lg">{data.position}</p>
            ...
            <div className="flex flex-wrap mt-4 space-x-2 transition-all duration-300 ease-in-out md:flex-row">
              <p className="w-auto px-2 py-2 mb-2 text-xs font-semibold bg-blue-100 border border-gray-300 sm:text-sm text-gray rounded-2xl">
                {data.city}
              </p>
