...
[JobTrackr](https://jobtrackr.azurewebsites.net/) is a full-stack web application. It consists of both frontend and backend components with the purpose of allowing users to track their job applications. 
